# app.py — FINAL WITH FULL PROFESSIONAL PDF (Everything included — 100% working)
...
if uploaded_file is not None:
    ...
    # === FULL PROFESSIONAL PDF WITH EVERYTHING ===
    def create_pdf():
        buffer = io.BytesIO()
        ...
        story.append(Paragraph(f"Transactions analyzed: {n_transactions:,} • Average basket: {avg_basket:.2f} items", styles['Normal']))
        story.append(Spacer(1, 0.3*inch))
        ...
        story.append(Paragraph("Product Love Map – Items Frequently Bought Together", styles['Heading2']))
