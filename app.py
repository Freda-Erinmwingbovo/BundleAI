# app.py — FINAL 100% WORKING (No Kaleido, no errors, full PDF)
...
if uploaded_file is not None:
    with st.spinner("BundleAI is analysing your data..."):
        ...
        # Generate charts as PNG bytes (NO KALEIDO NEEDED)
        ...
        chart1_bytes = fig1.to_image(format="png")
        ...
        chart2_bytes = fig2.to_image(format="png")
